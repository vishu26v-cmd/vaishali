    ...
    value: function onStepBegin(test, _result, step) {
      ...
      if (isHookStep) {
        if (["test.attach", "attach"].includes(step.category)) {
          var _stack$currentStep, _this$attachmentTarge2;
          ...
          while (1) switch (_context.n) {
            ...
            case 2:
              ...
              if (stepInfo !== null && stepInfo !== void 0 && stepInfo.hookStep) {
                targetStack = (0, _utils.isBeforeHookStep)(stepInfo.hookStep) ? beforeHooksStack : afterHooksStack;
              ...
              if (stepInfo.hookStep) {
                _targetStack = (0, _utils.isBeforeHookStep)(stepInfo.hookStep) ? beforeHooksStack : afterHooksStack;
            ...
            case 5:
              ...
              _targetStack2 = (0, _utils.isBeforeHookStep)(hookStep) ? beforeHooksStack : afterHooksStack;
              if (_targetStack2) {
                stepResult = _targetStack2.findStepByUuid(hookStep.uuid);
                if (stepResult) {

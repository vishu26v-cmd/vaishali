...
export declare abstract class BaseMessageTestRuntime implements TestRuntime {
    ...
    protected createSyncPromiseError(): Error;
    protected createSyncRuntime(sendMessageSync: (message: RuntimeMessage) => void): SyncTestRuntime;
    protected syncAttachment(_: (message: RuntimeMessage) => void, name: string, content: Buffer | Uint8Array | string, options: AttachmentOptions): void;
    protected syncGlobalAttachment(_: (message: RuntimeMessage) => void, name: string, content: Buffer | Uint8Array | string, options: AttachmentOptions): void;
